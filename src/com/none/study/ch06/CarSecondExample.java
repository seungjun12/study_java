...
public class CarSecondExample {
	...
	public static void main(String[] args) {
		...
		CarSecond carsecond5 = new CarSecond("그랜저",2000);
		CarSecond carsecond6 = new CarSecond("베뉴",5000,"black");
		...
		System.out.println("carsecond5.color:"+carsecond5.color);

		System.out.println("carsecond6.name:"+carsecond6.name);
		System.out.println("carsecond6.cc:"+carsecond6.cc);
