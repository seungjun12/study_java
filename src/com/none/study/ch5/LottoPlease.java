...
/*		double min = 1;
		...
		int[] random = {random1,random2,random3,random4,random5,random6};
		...
		//오름차순으로 순서 정렬 random 에서 오름차순을 만들어 보자 ㅋ
		...
		for(int i=0;i<random.length;i++) {
			System.out.println(random[i]+"의 등수는" +rank[i]);
		}
...
//			randomArray[5]=9;
			...
			// 오름차순 정렬
			Arrays.sort(randomArray);//여기까지 함
